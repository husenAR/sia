            ...
            <li ><a href="#"><i class="fa fa-circle-o"></i> Penilaian</a>
             <ul class="treeview-menu">
              ...
              if (in_array("27", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>kesiswaan/kaldik"><i class="fa fa-circle-o text-red"></i> KALDIK</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("28", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>kesiswaan/kurikulum"><i class="fa fa-circle-o text-red"></i> Kurikulum Sekolah</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("29", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>kesiswaan/nilaisiswa"><i class="fa fa-circle-o text-red"></i> Presensi Siswa</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("30", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>kesiswaan/nilaisiswa"><i class="fa fa-circle-o text-red"></i> Nilai Siswa</a></li>  
                <?php
              }
              ?>
              ...
              if (in_array("31", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>kesiswaan/kategorinilai"><i class="fa fa-circle-o text-red"></i> Kategori Nilai</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("32", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>kesiswaan/jenisnilaiakhir"><i class="fa fa-circle-o text-red"></i> Jenis Nilai Akhir</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("33", $arrmenuakses)) {
                ?>
                <li><a href="<?php echo base_url();?>kesiswaan/deskripsinilai"><i class="fa fa-circle-o text-red"></i> Deskripsi Nilai</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("34", $arrmenuakses)) {
                ?>
                <li><a href="<?php echo base_url();?>kesiswaan/rapor"><i class="fa fa-circle-o text-red"></i> Rapor</a></li>
                <?php
              }
              ?>
    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
        ...
        if (in_array("36", $arrmenuakses)) {
          ?>
          <li><a href="<?php echo site_url('kesiswaan/datapegawai');?>"><i class="fa fa-circle-o"></i>Data Pegawai</a></li>
          <?php
        }
        ?>
        ...
        if (in_array("37", $arrmenuakses)) {
          ?>
          <li><a href="<?php echo site_url('kesiswaan/presensipegawai');?>"><i class="fa fa-circle-o"></i>Presensi Pegawai</a></li>
          <?php
        }
        ?>
          ...
          <li class="treeview"><a href="#"><i class="fa fa-circle-o"></i> Ekstrakurikuler</a>
            <ul class="treeview-menu">
              ...
              if (in_array("40", $arrmenuakses)) {
                ?>
                <li><a href="<?php echo base_url();?>kesiswaan/pendaftaran"><i class="fa fa-circle-o text-red"></i>Pendaftaran</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("41", $arrmenuakses)) {
                ?>
                <li><a href="<?php echo base_url();?>kesiswaan/jadwal"><i class="fa fa-circle-o text-red"></i> Jadwal Ekstrakurikuler</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("42", $arrmenuakses)) {
                ?>
                <li><a href="<?php echo base_url();?>kesiswaan/presensi"><i class="fa fa-circle-o text-red"></i> Presensi</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("43", $arrmenuakses)) {
                ?>
                <li><a href="<?php echo base_url();?>kesiswaan/nilai"><i class="fa fa-circle-o text-red"></i> Nilai</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("44", $arrmenuakses)) {
                ?>
                <li><a href="<?php echo base_url();?>kesiswaan/pembayaran"><i class="fa fa-circle-o text-red"></i> Pendanaan</a></li>
                <?php
              }
              ?>
          ...
          <li class="treeview"><a href="#"><i class="fa fa-circle-o"></i> Bimbingan Konseling</a>
           <ul class="treeview-menu">
            ...
            if (in_array("46", $arrmenuakses)) {
              ?>
              <li ><a href="<?php echo base_url();?>kesiswaan/keterlambatan"><i class="fa fa-circle-o text-red"></i> Keterlambatan & Jam</a></li>
              <?php 
            }
            ?>
            ...
            if (in_array("47", $arrmenuakses)) {
              ?>
              <li><a href="<?php echo base_url();?>kesiswaan/absensi_harian"><i class="fa fa-circle-o text-red"></i> Perizinan</a></li>
              <?php 
            }
            ?>
            ...
            if (in_array("48", $arrmenuakses)) {
              ?>
              <li><a href="<?php echo base_url();?>kesiswaan/pelanggaran"><i class="fa fa-circle-o text-red"></i> Pelanggaran</a></li>
              <?php 
            }
            ?>
            ...
            if (in_array("49", $arrmenuakses)) {
              ?>
              <li><a href="<?php echo base_url();?>kesiswaan/prestasi"><i class="fa fa-circle-o text-red"></i> Prestasi</a></li>
              <?php 
            }
            ?>
          </ul>
