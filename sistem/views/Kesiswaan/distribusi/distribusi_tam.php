<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url();?>kesiswaan">Dashboard</a></li>
      </ol>
    </section>
            ...
            <li><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Tambah Kelas</a>
                  ...
                  <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                             <a href="<?php echo base_url();?>kesiswaan/hasil_pembagian_tambahan"><button type="button" class="btn btn-primary">Bagi Kelas</button></a>
                          </div>
                        </div>
