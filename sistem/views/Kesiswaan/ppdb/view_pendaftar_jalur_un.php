      ...
      <div class="col-md-12">
        <div class="nav-tabs-custom">
          <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
            ...
            <li role="presentation" class=""><a href="#tab_grade" role="tab" id="profile-tab" aria-expanded="false">Passing Grade</a></li>
          ...
          <div id="myTabContent" class="tab-content">
            <div role="tabpanel" class="tab-pane fade active in" id="tab_formulir" aria-labelledby="home-tab">
              <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo site_url('kesiswaan/admin/pendaftar_jalur_un/saveformnegeri'); ?>">  
                <div class="form-group">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12" align="right">
                    <a href="<?php echo site_url('kesiswaan/calon_siswa/form_ppdb'); ?>" target="_blank" class="btn btn-default"><i class="fa fa-external-link-square text-blue" aria-hidden="true"></i> Lihat Halaman Formulir PPDB</a>
                  </div><br><br>
                  ...
                  <p><center>Berikan centang pada atribut formulir yang ingin dikeluarkan sebagai Formulir Penerimaan Peserta Didik Baru:</p></center>  
                    <div class="col-md-9 col-sm-9 col-xs-9">
                      ...
                      <div class="modal-footer" align="center">
                        <a href="<?php echo site_url('kesiswaan/admin/pendaftar_jalur_un/nonaktifform'); ?>" class="btn btn-danger">Non Aktifkan Formulir</a>
...
<!-- ========================================= end tab 1 ========================================= -->
              ...
              <div role="tabpanel" class="tab-pane fade" id="tab_ketentuan" aria-labelledby="profile-tab">
                ...
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo site_url('kesiswaan/admin/pendaftar_jalur_un/saveketentuan'); ?>" enctype="multipart/form-data">
                  <div class="form-group">
                ...
                <?php 
                  ...
                  foreach ($tabel_ketentuan_ppdb as $row) 
                  {
                    ...
                    <tr>
                      ...
                      <td>                        
                        <a data-toggle="modal" class="btn btn-info btn-xs" data-show="true" href="<?php echo site_url('kesiswaan/admin/pendaftar_jalur_un/editketentuan/'.$row->id_ketentuan); ?>" data-target="#myKetentuan<?php echo $i; ?>">Edit</a>
                      </td>
                      <td>
...
<!-- =========================================== end tab 2 ======================================= -->
              ...
              <div class="tab-pane fade" id="tab_grade" aria-labelledby="profile-tab">
                <div class="tab-pane">
                  <h4><center><b>Tetapkan Passing Grade</b></center></h4><br>
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo site_url('kesiswaan/admin/pendaftar_jalur_un/savepassing'); ?>" >
                    <div class="form-group">
                  ...
                  <br>
                  <h4><center><b>History Passing Grade</b></center></h4>
                  <div class="col-md-2 col-sm-6 col-xs-12 col-md-offset-5 col-sm-offset-3" align="center">
                    <select class="form-control filter-tahun-un-grade" name="id_tahunajaran" required>
                  ...
                  <table class="table table-striped projects examples">
                    ...
                    <tbody class="searchable">
                      ...
                      <tr>
                        ...
                        <td><?php echo $row->tgl_berlaku; ?></td>
                        <td>
                          <a href="<?php echo site_url('kesiswaan/admin/pendaftar_jalur_un/deletegrade/'.$row->id_grade); ?>" class="btn btn-default btn-xs" onclick="return confirm('Apakah yakin data dihapus?');"><i class="fa fa-trash text-red" aria-hidden="true"></i> Hapus</a>
                        </td>
                      </tr>
                      <?php
                      $i=$i+1;
...
<!-- ========================================= end tab 3 ============================================ -->
              ...
              <div role="tabpanel" class="tab-pane fade" id="tab_pendaftar" aria-labelledby="profile-tab">
                ...
                <div class="col-md-2 col-sm-6 col-xs-12 col-md-offset-5 col-sm-offset-3" align="center">
                  <select class="form-control filter-tahun-un" name="id_tahunajaran" required>
                  <option value="semua">Tahun Ajaran</option>
                    <?php foreach ($tahun_ajaran as $key => $value) {
                      $selected = $value->tahun_ajaran == $tahun_ajaran_selected ? 'selected' : '';
                     ?>
                  ...
                  <form method="post" action="<?php echo site_url('kesiswaan/admin/pendaftar_jalur_un/ubahstatus');?>">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th width="10">No <i class="fa fa-caret-down" aria-hidden="true"></i> </th>
                        ...
                        <th width="10">Total Nilai <i class="fa fa-caret-down" aria-hidden="true"></i></th>
                        <th width="10"></th>
                        <th width="10">Verifikasi <i class="fa fa-caret-down" aria-hidden="true"></i> </th>
...
<!-- =============================== END OF TAB CONTENT 4 ================================== -->
                ...
                <div role="tabpanel" class="tab-pane fade" id="tab_lolos" aria-labelledby="profile-tab">
                  ...
                  <div class="col-md-2 col-sm-6 col-xs-12 col-md-offset-5 col-sm-offset-3" align="center">
                 <select class="form-control filter-tahun-un-lolos" name="id_tahunajaran" required>
                  <option value="semua">Tahun Ajaran</option>
                    <?php foreach ($tahun_ajaran as $key => $value) {
                      $selected = $value->tahun_ajaran == $tahun_ajaran_selected ? 'selected' : '';
                     ?>
                    ...
                    <div class="row">
                      <div class="col-sm-4">
                        <div class="dataTables_length" id="example1_length">
                          <div class="form-group" align="right">
                          <a type="button" role="button" href=<?php echo site_url('kesiswaan/admin/pendaftar_jalur_un/eksportujian');?> class="btn btn-default"><i class="fa fa-print text-red "></i> Export Data Pendaftar</a>
                        </div>
                        </div>
                      </div>
                      <div class="col-sm-4">
                        <div class="dataTables_length" id="example1_length">
                          <div class="form-group" align="left">
                            <a data-toggle="modal" class="btn btn-default" data-show="true" href="<?php echo site_url('kesiswaan/admin/pendaftar_jalur_un/impordata'); ?>" data-target="#myImpor"><i class="fa fa-cloud-download text-blue" aria-hidden="true"></i> Import Data Pendaftar</a>
                          </div>
                        </div>
                      </div>
                      <div class="col-sm-4">
                    ...
                    <table class="table table-striped projects examples">
                      <thead>
                        <tr>
                          ...
                          <th width="10">Domisili <i class="fa fa-caret-down" aria-hidden="true"></i> </th>
                          <th width="10">Penilaian <i class="fa fa-caret-down" aria-hidden="true"></i> </th>
                          <th width="10"></th>
                          <th width="10"></th>
                        </tr>
                      </thead>
                      <tbody class="searchable">
                        ...
                        foreach ($tabel_pendaftar_ppdb_lolos as $row) 
                        {
                          ...
                          <tr>
                            ...
                            <td><?php echo $row->nilai_un_nun; ?></td>
                            <td>
                             <a data-toggle="modal" class="btn btn-default btn-xs" data-show="true" href="<?php echo site_url('kesiswaan/admin/pendaftar_jalur_un/editnilai/'.$row->nisn_pendaftar); ?>" data-target="#myNilailolos<?php echo $i; ?>">Detail</a>
                            </td>
                            <td>
                             <a data-toggle="modal" class="btn btn-info btn-xs" data-show="true" href="<?php echo site_url('kesiswaan/admin/pendaftar_jalur_un/editpendaftarlolos/'.$row->nisn_pendaftar); ?>" data-target="#myPendaftarlolos<?php echo $i; ?>">Edit</a>
                            </td>
                          </tr>
                          <?php
                          $i=$i+1;
...
<!-- =============================== END OF TAB CONTENT 5 ================================== -->
                  ...
                  <div role="tabpanel" class="tab-pane fade" id="tab_pengumuman" aria-labelledby="profile-tab">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo site_url('kesiswaan/admin/pendaftar_jalur_un/savepengumuman'); ?>" enctype="multipart/form-data">
                      <div class="form-group">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>                        
                        <a data-toggle="modal" class="btn btn-info btn-xs" data-show="true" href="<?php echo site_url('kesiswaan/admin/pendaftar_jalur_un/editpengumuman/'.$row->id_pengumuman_ppdb); ?>" data-target="#myPengumuman<?php echo $i; ?>">Edit</a>
                      <td>
