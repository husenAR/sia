<html>
  <body>
    <div class="modal-dialog">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
          ...
          <div class="form-group" align="left">
            <a type="button" role="button" href=<?php echo site_url('kesiswaan/admin/buku_induk/ekspordata/'. $row_siswa->nisn);?> class="btn btn-default"><i class="fa fa-print text-red "></i> Export Data Lengkap Siswa</a>
          </div>
      </div>
      <div class="modal-content">
        <form id="formPartE" class="form-horizontal style-form form-goods" method="post" action="<?php echo site_url('kesiswaan/admin/buku_induk/updatesiswa/'.$row_siswa->nisn); ?>" enctype="multipart/form-data"><br>    
      ...
      <div class="form-group">
        <label class="control-label col-md-3 col-sm-3 col-xs-12">Nilai UN</label>
      ...
      <div class="form-group">
        <label class="control-label col-md-3 col-sm-3 col-xs-12">Nilai UN Bahasa Indonesia </label>
         <div class="col-md-3 col-sm-3 col-xs-3">
          <input type="text" class="form-control" name="nilai_un_ind" value="<?php echo $row_siswa->nilai_un_ind; ?>">
        </div>
      </div><br><br><br>
      <div class="form-group">
        <label class="control-label col-md-3 col-sm-3 col-xs-12">UN Matematika </label>
         <div class="col-md-3 col-sm-3 col-xs-3">
          <input type="text" class="form-control" name="nilai_un_mat" value="<?php echo $row_siswa->nilai_un_mat; ?>">
        </div>
      </div><br><br>
      <div class="form-group">
        <label class="control-label col-md-3 col-sm-3 col-xs-12">UN IPA </label>
          <div class="col-md-3 col-sm-3 col-xs-3">
          <input type="text" class="form-control" name="nilai_un_ipa" value="<?php echo $row_siswa->nilai_un_ipa; ?>">
        </div>
      </div><br><br>
      <div class="form-group">
        <label class="control-label col-md-3 col-sm-3 col-xs-12">Nilai Prestasi </label>
         <div class="col-md-3 col-sm-3 col-xs-3">
          <input type="text" class="form-control" name="nilai_prestasi" value="<?php echo $row_siswa->nilai_prestasi; ?>">
        </div>
      </div> <br><br>
      <div class="form-group">
        <label class="control-label col-md-3 col-sm-3 col-xs-12">Total Nilai </label>
         <div class="col-md-3 col-sm-3 col-xs-3">
          <input type="text" class="form-control" name="nilai_un_nun" value="<?php echo $row_siswa->nilai_un_nun; ?>">
        </div>
      </div><br><br>
      <div class="form-group">
      ...
      <div class="form-group">
        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Nomor Penerima</label>
          <div class="col-md-6 col-sm-6 col-xs-12">
