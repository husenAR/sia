      ...
      <div class="col-md-12">
        <div class="nav-tabs-custom">
          <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
            ...
            <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false">Pendaftar </a></li>
          </ul>
          ...
          <div id="myTabContent" class="tab-content">
            <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
              <div class="form-group">
                ...
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo site_url('kesiswaan/admin/daftarulang_kenaikan/saveformkenaikan'); ?>">  
                      ...
                      <script type="text/javascript">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-9">
                          ...
                          { 
                            if ($i<5) 
                            {
                              ?><input type="checkbox" class="flat" name="nilai<?php echo $form->id_form_daftarulang_kenaikan; ?>" value="1" <?php 
                              if ($form->nilai == "1") 
                              { echo " checked"; } ?>
                          ...
                          <div class="modal-footer" align="right">
                            <a href="<?php echo site_url('kesiswaan/admin/daftarulang_kenaikan/nonaktif'); ?>" class="btn btn-danger">Non Aktifkan Formulir</a>
  ...
  <!-- ========================================= end tab 1 ========================================== -->
            ...
            <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
              ...
              <div class="col-md-2 col-sm-6 col-xs-12 col-md-offset-5 col-sm-offset-3" align="center">
                <select class="form-control filter-tahun-duk" name="id_tahunajaran" required>
              ...
              <table class="table table-striped projects" id="example1">
                <thead>
                  <tr>
                    ...
                    <th style="width: 10%">NISN <i class="fa fa-caret-down" aria-hidden="true"></i> </th>
                    <th style="width: 45%">Nama <i class="fa fa-caret-down" aria-hidden="true"></i> </th>
                    <th style="width: 10%">Th Angkatan <i class="fa fa-caret-down" aria-hidden="true"></i>  </th>
                  ...
                  foreach ($tabel_pendaftar_daftarulang_kenaikan as $row)
                    {
                      ...
                      <tr>
                        <td><?php echo $i; ?></td>
                        <td><?php echo $row->tahunajaran;//dari id_tahun_ajaran di PENDAFTAR DU KENAIKAN ?></td> 
                        <td><?php echo $row->nisn; ?></td>
                        <td><?php echo $row->nama; ?></td>
                        <td><?php echo $row->angkatan; //dari id_tahunajaran di SISWA ?></td>
                        <td><?php echo $row->terverifikasi; ?></td>
                        <td><a data-toggle="modal" class="btn btn-info btn-xs" data-show="true" href="<?php echo site_url('kesiswaan/admin/daftarulang_kenaikan/editberkas/'.$row->nisn); ?>" data-target="#myPendaftar<?php echo $i; ?>">Edit</a>
                        </td>
                      </tr>
