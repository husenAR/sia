      ...
      <div class="col-md-12">
                ...
                <tbody>
                  ...
                  foreach ($tabel_jadwalekskul as $row_jadwalekskul) {
                    ...
                    <tr>
                      ...
                      <td> 
                        <a class="btn btn-block btn-primary button-action btnedit" href="<?php echo site_url('gurupiket/ekstrakurikuler/'.$row_jadwalekskul->id_jadwal_ekskul); ?>" > Edit </a>
                        <a onclick="return confirm('Apakah Anda yakin?')" class="btn btn-danger btn-primary button-action btnhapus" href="<?php echo site_url('gurupiket/hapusjadwalekskul/'.$row_jadwalekskul->id_jadwal_ekskul); ?>" > Hapus </a>
                      </td>               
                    </tr>
                    <?php
                  }
        ...
        <!-- /.tab-pane -->
          ...
          <div class="active tab-pane" id="dataekskul">
               <form method="post" action="<?php echo site_url('gurupiket/simpanjadwalekskul'); ?>">
