...
<!-- <link rel="stylesheet" href="<?php echo base_url(); ?>assets/gurupiket/chosen/chosen.css"> -->
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#jammengajar" data-toggle="tab">Kelola Jam Mengajar gurupiket</a></li>
            ...
            <div class="tab-content">
              <div class="active tab-pane" id="jammengajar">
                <div class="box">
                  <!-- /.box-header -->
                  <p style="color: #ff0000">> Pilih <b>Nama</b> gurupiket, kemudian pilih <b>Mata Pelajaran</b> yang diampu dan isi <b>Jam Minim Mengajar</b><br>
                    > Kemudian <b>Submit</b></p>
                  <div class="box-body">
                    <div>
                      <!-- <div class="box-header jarakbox" style="padding-top: : 0px"> -->
                        <form method="post" action="<?php echo site_url('gurupiket/simpanjammengajar'); ?>">
                          <table class="table table-bordered">
                            <thead>
                              <tr>
                               ...
                               <!--  <th rowspan="3">Kode gurupiket</th> -->
                                <th rowspan="3"><center>Golongan</center></th>
                                <th rowspan="3"><center>Jabatan gurupiket</center></th>
                            ...
                            <tbody  style="text-align: center; padding-bottom: 5px">
                              ...
                              for ($i=1;$i<=10;$i++) {
                                ...
                                <tr>
                                  ...
                                  <td><select class="chosen" name="NIP<?php echo $i; ?>" id="NIP<?php echo $i; ?>" onchange="getinfogurupiket(<?php echo $i; ?>);">
                                    <option value="">...</option>
                                    <?php
                                  ...
                                  <!-- <td><span id="kode_text<?php echo $i; ?>">-</span><?php //echo $row_pegawai->kode_gurupiket; ?></td> -->
                  ...
                  <div class="tab-pane" id="kelolajammengajar">
                    <div class="box">
                          ...
                          <table id="example1" class="table table-bordered table-striped">
                            <thead>
                              <tr>
                                ...
                                <th >Nama</th>
                                <th >NIP</th>
                                <!-- <th >Kode gurupiket</th> -->
                                <th >Golongan</th>
                                <th >Jabatan gurupiket</th>
                                <th >Ijazah</th>
                            ...
                            <tbody>
                              ...
                              foreach ($tabel_jammengajar as $row_jammengajar) {
                                ...
                                <tr>
                                  ...
                                  <!-- <td><?php echo $row_jammengajar->kode_gurupiket; ?></td> -->
                                  ...
                                  <td><a onclick="return confirm('Apakah Anda yakin?')" href="<?php echo site_url('gurupiket/hapusjammengajar/'.$row_jammengajar->id_jam_mgjr); ?>" class="btn btn-danger">Hapus</a></td>
                      ...
                      <a href="<?php echo site_url('gurupiket/printjammengajar'); ?>" class=" btn btnjdwl">Print                   <!-- /.box-body -->
                ...
                <script type="text/javascript">
                  function getinfogurupiket(nomor) {
                    $.ajax({
                      url: '<?php echo site_url('gurupiket/getinfoguru'); ?>/'+document.getElementById('NIP'+nomor).value,
                      dataType: 'json',
                      cache: false,
                ...
                for(i=0;i<msg.data.length;i++){
                              ...
                              // document.getElementById('kode_text'+nomor).innerHTML = msg.data[i].kode_gurupiket;
            ...
            if ($this->session->userdata('jabatan') == 'gurupiket') {
             ...
             <script type="text/javascript">
                  function getinfogurupiket(nomor) {
                    $.ajax({
                      url: '<?php echo site_url('gurupiket/getinfogurupiket'); ?>/'+document.getElementById('NIP'+nomor).value,
                      dataType: 'json',
                      cache: false,
                      success: function(msg){
                //alert('ok');
