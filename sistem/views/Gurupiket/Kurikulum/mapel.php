...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li><a href="<?php echo site_url('gurupiketpiket');?>">Dashboard</a></li>
    </ol>
  </section>
            ...
            <div class="box">
              ...
              <div class="box-body">
                ...
                <div style="overflow: auto">
                  <form id="formmapel" style="display:block;" class="form-horizontal formmapel" method="post" action="<?php echo site_url('gurupiket/simpanmapel'); ?>">
              ...
              <div style="overflow: auto">
               <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tr>
                        ...
                        <td> 
                          <a class="btn btn-block btn-primary button-action btnedit" href="<?php echo site_url('gurupiket/mapel/'.$row_mapel->id_kelas_reguler.'/'.$row_mapel->jenjang.'/'.str_replace(" ", "_", $row_mapel->id_namamapel)); ?>" > Edit </a>
                          <a onclick="return confirm('Apakah Anda yakin?')" class="btn btn-danger btn-primary button-action btnhapus" href="<?php echo site_url('gurupiket/hapusmapelbyidjenjang/'.$row_mapel->id_kelas_reguler.'/'.$row_mapel->jenjang.'/'.str_replace(" ", "_", $row_mapel->id_namamapel)); ?>" > Hapus </a>
                        </td>               
                      </tr>
                      <?php
                ...
                <?php
                  for ($i=1;$i<=2;$i++) {
                    ...
                    <tr>
                      ...
                      ?>
                     <td><a href="<?php echo site_url('gurupiket/resumepresensipegawaisemester/'.$rowpeg->NIP.'/'.$thn.'/'.$i); ?>"><?php echo $rowpeg->Nama; ?></a></td>                    
