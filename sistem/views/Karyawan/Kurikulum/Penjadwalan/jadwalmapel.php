            ...
            <div class="tab-pane" id="jadwalmapel">
              <div class="box">
                <div class="box-header">
                  <form>
                    <select id="jenjangjadwalmapel2" onchange="document.location = '<?php echo site_url('karyawan/jadwalmapel'); ?>/' + document.getElementById('jenjangjadwalmapel2').value;">
...
<!-- <a href="<?php echo site_url('karyawan/printjadwalmapel/'.$jenjang); ?>" ><button class="btnjdwl"><i class="fa fa-print text-red "></i> Print</button></a> -->
<a href="<?php echo site_url('karyawan/exportjadwalmapel/'.$jenjang); ?>" ><button class="btnjdwl"><i class="fa fa-upload text-red "></i> Export</button></a>
</div>
<!-- /.box-body -->
</div>
...
<div class="active tab-pane" id="jadwalprioritas">
  <div class="box">
    ...
    <!-- /.box-header -->
    <div class="box-body">
      <form method="post" action="<?php echo site_url('karyawan/simpanprioritas'); ?>">
        <table class="table table-bordered table-striped tabelmapel">
                     ...
                     for($i=0;$i<=5;$i++) {
                      ...
                      <tr>
                        ...
                        foreach (@$tabel_prioritaskhusus_senin[$i] as $rowprioritaskhusus) {
                          $z++;
                          if ($z>1) { echo ", "; }
                          echo $rowprioritaskhusus->nama.'&nbsp;<a href="'.site_url('karyawan/hapusprioritas/'.$rowprioritaskhusus->id_prkh).'">X</a>&nbsp;';
                        }
                        ?> </th>
                        <th><?php 
                        $z=0;
...
<div class="tab-pane" id="jadwalkhusus">
  <div class="box">
    ...
    <!-- /.box-header -->
    <div class="box-body">
     <form method="post" action="<?php echo site_url('karyawan/simpankhusus'); ?>">
      <table class="table table-bordered table-striped tabelmapel">
        <p style="color: #ff0000">> Jadwal Khusus yaitu <b>karyawan</b> yang <b>tidak bisa mengajar</b> atau <b>memunyai aktifitas rutin lain</b> sehingga tidak bisa mengajar.<br>
          > Pilih karyawan, bisa lebih dari <b>satu</b>.</p>
          <thead>
            <tr class="barishari">
              <th class="tengah" >Jam ke</th>
              <!-- <th class="tengah" >Waktu</th> -->
          ...
          <tbody>
            ...
            for($i=0;$i<=12;$i++)  {
              ...
              <tr class="btnpilih">
                ...
                <!-- <th>&nbsp;</th> -->
                <th>
                  <select data-placeholder="Pilih karyawan" multiple class="chosen-select" name="NIP_senin_<?php echo $i; ?>[]" id="NIP_senin_<?php echo $i; ?>">
                    <?php
                  ...
                  <!-- <button class="btn btn-success button-form" data-toggle="modal" data-target="#review4" style="background-color:#00994d; border-color:#00994d;">Pilih karyawan</button> -->
                </th>
                <th>
                  <select data-placeholder="Pilih karyawan" multiple class="chosen-select" name="NIP_selasa_<?php echo $i; ?>[]" id="NIP_selasa_<?php echo $i; ?>">
                    <?php
                    foreach ($tabel_pegawai as $row_pegawai) {
                      ?>
                      <option value="<?php echo $row_pegawai->NIP; ?>"><?php echo $row_pegawai->kode_guru; ?>. <?php echo $row_pegawai->nama_panggilan; ?></option>
                  ...
                  <th>
                    <select data-placeholder="Pilih karyawan" multiple class="chosen-select" name="NIP_rabu_<?php echo $i; ?>[]" id="NIP_rabu_<?php echo $i; ?>">
                      <?php
                      foreach ($tabel_pegawai as $row_pegawai) {
                        ?>
                        <option value="<?php echo $row_pegawai->NIP; ?>"><?php echo $row_pegawai->kode_guru; ?>. <?php echo $row_pegawai->nama_panggilan; ?></option>
                  ...
                  <th>
                    <select data-placeholder="Pilih karyawan" multiple class="chosen-select" name="NIP_kamis_<?php echo $i; ?>[]" id="NIP_kamis_<?php echo $i; ?>">
                      <?php
                      foreach ($tabel_pegawai as $row_pegawai) {
                        ?>
                        <option value="<?php echo $row_pegawai->NIP; ?>"><?php echo $row_pegawai->kode_guru; ?>. <?php echo $row_pegawai->nama_panggilan; ?></option>
                  ...
                  <th>
                    <select data-placeholder="Pilih karyawan" multiple class="chosen-select" name="NIP_jumat_<?php echo $i; ?>[]" id="NIP_jumat_<?php echo $i; ?>">
                      <?php
                      foreach ($tabel_pegawai as $row_pegawai) {
                        ?>
                        <option value="<?php echo $row_pegawai->NIP; ?>"><?php echo $row_pegawai->kode_guru; ?>. <?php echo $row_pegawai->nama_panggilan; ?></option>
                  ...
                  <th>
                    <select data-placeholder="Pilih karyawan" multiple class="chosen-select" name="NIP_sabtu_<?php echo $i; ?>[]" id="NIP_sabtu_<?php echo $i; ?>">
                      <?php
                      foreach ($tabel_pegawai as $row_pegawai) {
                        ?>
                        <option value="<?php echo $row_pegawai->NIP; ?>"><?php echo $row_pegawai->kode_guru; ?>. <?php echo $row_pegawai->nama_panggilan; ?></option>
                  ...
                  <th>
                    <select data-placeholder="Pilih karyawan" multiple class="chosen-select" name="NIP_minggu_<?php echo $i; ?>[]" id="NIP_minggu_<?php echo $i; ?>">
                      <?php
                      foreach ($tabel_pegawai as $row_pegawai) {
                        ?>
                        <option value="<?php echo $row_pegawai->NIP; ?>"><?php echo $row_pegawai->kode_guru; ?>. <?php echo $row_pegawai->nama_panggilan; ?></option>
            ...
            for($i=0;$i<=12;$i++) {
              ...
              <tr>
                ...
                foreach (@$tabel_khusus_senin[$i] as $rowprioritaskhusus) {
                  $z++;
                  if ($z>1) { echo ", "; }
                  echo $rowprioritaskhusus->nama_panggilan.'&nbsp;<a href="'.site_url('karyawan/hapusprioritas/'.$rowprioritaskhusus->id_prkh).'">X</a>&nbsp;';
                }
                ?> </th>
                <th><?php 
                $z=0;
  ...
  <div class="tab-pane" id="kelolajadwalmapel">
    <div class="box">
      <div class="box-header">
        <form>
          <select id="jenjangjadwalmapel" onchange="document.location = '<?php echo site_url('karyawan/jadwalmapel'); ?>/' + document.getElementById('jenjangjadwalmapel').value;">
            <option value="7" <?php if ($jenjang == '7') { echo " selected"; } ?>> KELAS 7</option>
            <option value="8" <?php if ($jenjang == '8') { echo " selected"; } ?>> KELAS 8</option>
            <option value="9" <?php if ($jenjang == '9') { echo " selected"; } ?>> KELAS 9</option>
          </select>
      ...
      <div class="box-body">
        <div style="overflow-x: scroll; width: 1090px">
          <form method="post" action="<?php echo site_url('karyawan/simpanjadwalguru/senin/'.$jenjang); ?>">
                ...
                for($i=0;$i<=12;$i++)  {
                  ...
                  <tr>
                    ...
                    foreach ($tabel_kelasreguler as  $row_kelasreguler) {
                      ?>
                      <th>
                        <select data-placeholder="Pilih" class="kodekaryawan" name="jadwal_senin_<?php echo $row_kelasreguler->id_kelas_reguler; ?>_<?php echo $i; ?>" id="jadwal_senin_<?php echo $row_kelasreguler->id_kelas_reguler; ?>_<?php echo $i; ?>" style="width: 120px;">
                          <option value="">...</option>
                          <?php 
                          foreach (@$tabel_jadwalprioritas_senin[$i] as $rowjadwalprioritas) {
                            $ada = false;
        ...
        <div style="overflow-x: scroll; width: 1090px">
          <form method="post" action="<?php echo site_url('karyawan/simpanjadwalkaryawan/selasa/'.$jenjang); ?>">
              ...
              for($i=0;$i<=12;$i++)  {
                ...
                <tr>
                  ...
                  foreach ($tabel_kelasreguler as  $row_kelasreguler) {
                    ?>
                    <th>
                      <select data-placeholder="Pilih" class="kodekaryawan" name="jadwal_selasa_<?php echo $row_kelasreguler->id_kelas_reguler; ?>_<?php echo $i; ?>" id="jadwal_selasa_<?php echo $row_kelasreguler->id_kelas_reguler; ?>_<?php echo $i; ?>" style="width: 120px;">
                        <option value="">...</option>
                        <?php 
                        foreach (@$tabel_jadwalprioritas_selasa[$i] as $rowjadwalprioritas) {
                          $ada = false;
      ...
      <div style="overflow-x: scroll; width: 1090px">
        <form method="post" action="<?php echo site_url('karyawan/simpanjadwalkaryawan/rabu/'.$jenjang); ?>">
              ...
              for($i=0;$i<=12;$i++)  {
                ...
                <tr>
                  ...
                  foreach ($tabel_kelasreguler as  $row_kelasreguler) {
                    ?>
                    <th>
                      <select data-placeholder="Pilih" class="kodekaryawan" name="jadwal_rabu_<?php echo $row_kelasreguler->id_kelas_reguler; ?>_<?php echo $i; ?>" id="jadwal_rabu_<?php echo $row_kelasreguler->id_kelas_reguler; ?>_<?php echo $i; ?>" style="width: 120px;">
                        <option value="">...</option>
                        <?php 
                        foreach (@$tabel_jadwalprioritas_rabu[$i] as $rowjadwalprioritas) {
                          $ada = false;
      ...
      <div style="overflow-x: scroll; width: 1090px">
        <form method="post" action="<?php echo site_url('karyawan/simpanjadwalkaryawan/kamis/'.$jenjang); ?>">
              ...
              for($i=0;$i<=12;$i++)  {
                ...
                <tr>
                  ...
                  foreach ($tabel_kelasreguler as  $row_kelasreguler) {
                    ?>
                    <th>
                      <select data-placeholder="Pilih" class="kodekaryawan" name="jadwal_kamis_<?php echo $row_kelasreguler->id_kelas_reguler; ?>_<?php echo $i; ?>" id="jadwal_kamis_<?php echo $row_kelasreguler->id_kelas_reguler; ?>_<?php echo $i; ?>" style="width: 120px;">
                        <option value="">...</option>
                        <?php 
                        foreach (@$tabel_jadwalprioritas_kamis[$i] as $rowjadwalprioritas) {
                          $ada = false;
      ...
      <div style="overflow-x: scroll; width: 1090px">
        <form method="post" action="<?php echo site_url('karyawan/simpanjadwalkaryawan/jumat/'.$jenjang); ?>">
              ...
              for($i=0;$i<=12;$i++)  {
                ...
                <tr>
                  ...
                  foreach ($tabel_kelasreguler as  $row_kelasreguler) {
                    ?>
                    <th>
                      <select data-placeholder="Pilih" class="kodekaryawan" name="jadwal_jumat_<?php echo $row_kelasreguler->id_kelas_reguler; ?>_<?php echo $i; ?>" id="jadwal_jumat_<?php echo $row_kelasreguler->id_kelas_reguler; ?>_<?php echo $i; ?>" style="width: 120px;">
                        <option value="">...</option>
                        <?php 
                        foreach (@$tabel_jadwalprioritas_jumat[$i] as $rowjadwalprioritas) {
                          $ada = false;
      ...
      <div style="overflow-x: scroll; width: 1090px">
        <form method="post" action="<?php echo site_url('karyawan/simpanjadwalkaryawan/sabtu/'.$jenjang); ?>">
              ...
              for($i=0;$i<=12;$i++)  {
                ...
                <tr>
                  ...
                  foreach ($tabel_kelasreguler as  $row_kelasreguler) {
                    ?>
                    <th>
                      <select data-placeholder="Pilih" class="kodekaryawan" name="jadwal_sabtu_<?php echo $row_kelasreguler->id_kelas_reguler; ?>_<?php echo $i; ?>" id="jadwal_sabtu_<?php echo $row_kelasreguler->id_kelas_reguler; ?>_<?php echo $i; ?>" style="width: 120px;">
                        <option value="">...</option>
                        <?php 
                        foreach (@$tabel_jadwalprioritas_sabtu[$i] as $rowjadwalprioritas) {
                          $ada = false;
      ...
      <div style="overflow-x: scroll; width: 1090px">
        <form method="post" action="<?php echo site_url('karyawan/simpanjadwalkaryawan/minggu/'.$jenjang); ?>">
              ...
              for($i=0;$i<=12;$i++)  {
                ...
                <tr>
                  ...
                  foreach ($tabel_kelasreguler as  $row_kelasreguler) {
                    ?>
                    <th>
                      <select data-placeholder="Pilih" class="kodekaryawan" name="jadwal_minggu_<?php echo $row_kelasreguler->id_kelas_reguler; ?>_<?php echo $i; ?>" id="jadwal_minggu_<?php echo $row_kelasreguler->id_kelas_reguler; ?>_<?php echo $i; ?>" style="width: 120px;">
                        <option value="">...</option>
                        <?php 
                        foreach (@$tabel_jadwalprioritas_minggu[$i] as $rowjadwalprioritas) {
                          $ada = false;
...
<!-- modal -->
  ...
  <script type="text/javascript">
              // function getmapel() {
              //   $.ajax({
              //     url: '<?php echo site_url('karyawan/getmapelkelas'); ?>/'+document.getElementById('jenjang').value,
              //     dataType: 'json',
              //     cache: false,
