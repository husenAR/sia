...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li><a href="karyawan">Dashboard</a></li>
    </ol>
  </section>
  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs">
           ...
           if ($this->session->userdata('jabatan') == 'karyawan') {
            ?>
            <li ><a href="#datakelolamapelkaryawan" data-toggle="tab"><?php if (@$edit_mapel) { echo "Edit"; } else { echo "Tambah"; } ?> Mata Pelajaran </a></li>
            <?php 
          } 
          ?>
                  ...
                  foreach ($tabel_namamapel as $row_namamapel) {
                    ...
                    <tr>
                      ...
                      <td> 
                       ...
                       if ($this->session->userdata('jabatan') == 'karyawan') {
                        ?>
                        <a class="btn btn-block btn-primary button-action btnedit" href="<?php echo site_url('karyawan/namamapel/'.$row_namamapel->id_namamapel); ?>" > Edit </a>
                        <a onclick="return confirm('Apakah Anda yakin?')" class="btn btn-danger btn-primary button-action btnhapus" href="<?php echo site_url('karyawan/hapusnamamapel/'.$row_namamapel->id_namamapel); ?>" > Hapus </a>
                        <?php 
                      }
                      ?>
        ...
        <!-- /.tab-pane -->
        <!-- Data Kelola Mapel karyawan -->

        <div class="tab-pane" id="datakelolamapelkaryawan">
         <form id="formmapel" style="display:block;" class="form-horizontal formmapel" method="post" action="<?php echo site_url('karyawan/simpannamamapel'); ?>">
      ...
      <!-- tutup data kelola mapel karyawan -->
