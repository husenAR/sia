      ...
      <div class="col-md-12 ">
        ...
        <div class="box box-primary box-dashboard">
          <div class="box-body box-profile">
            ...
            <img class="profile-user-img img-responsive img-circle" src="<?php echo base_url();?>/assets/penjadwalan/karyawan/fotoguru/<?php echo $foto ?>" alt="User profile picture">
