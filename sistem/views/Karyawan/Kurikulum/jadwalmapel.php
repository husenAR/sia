      ...
      <table class="table table-bordered table-striped tabelmapel">
        ...
        <tbody>
         ...
         <tr class="btnpilih">
          ...
          <th>07.00 - 08.00</th>
          <th>
           <button class="btn btn-success button-form" data-toggle="modal" data-target="#review4" style="background-color: #8cd9b3; border-color:  #8cd9b3;">Pilih karyawan</button>
         </th>
         <th>
           <button class="btn btn-success button-form" data-toggle="modal" data-target="#review4" style="background-color: #8cd9b3; border-color:  #8cd9b3;">Pilih karyawan</button>
           <th>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Daftar karyawan Jadwal Khusus</h4>
      </div>
      <div class="modal-body">
        <form id="formPartE" class="form-horizontal style-form form-goods" method="post" action="#" enctype="multipart/form-data">
          <div class="form-group">
            <label class="col-sm-2 col-sm-2 control-label">Pilih karyawan :</label>
            <div class="col-sm-10">
              <ul class="titik">
