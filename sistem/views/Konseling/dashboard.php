            ...
            <li ><a href="#"><i class="fa fa-circle-o"></i> Penilaian</a>
             <ul class="treeview-menu">
              ...
              if (in_array("27", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>konseling/kaldik"><i class="fa fa-circle-o text-red"></i> KALDIK</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("28", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>konseling/kurikulum"><i class="fa fa-circle-o text-red"></i> Kurikulum Sekolah</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("29", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>konseling/nilaisiswa"><i class="fa fa-circle-o text-red"></i> Presensi Siswa</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("30", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>konseling/nilaisiswa"><i class="fa fa-circle-o text-red"></i> Nilai Siswa</a></li>  
                <?php
              }
              ?>
              ...
              if (in_array("31", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>konseling/kategorinilai"><i class="fa fa-circle-o text-red"></i> Kategori Nilai</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("32", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>konseling/jenisnilaiakhir"><i class="fa fa-circle-o text-red"></i> Jenis Nilai Akhir</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("33", $arrmenuakses)) {
                ?>
                <li><a href="<?php echo base_url();?>konseling/deskripsinilai"><i class="fa fa-circle-o text-red"></i> Deskripsi Nilai</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("34", $arrmenuakses)) {
                ?>
                <li><a href="<?php echo base_url();?>konseling/rapor"><i class="fa fa-circle-o text-red"></i> Rapor</a></li>
                <?php
              }
              ?>
    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
        ...
        if (in_array("36", $arrmenuakses)) {
          ?>
          <li><a href="<?php echo site_url('konseling/pegawaibaru');?>"><i class="fa fa-circle-o"></i>Data Pegawai</a></li>
          <?php
        }
        ?>
        ...
        if (in_array("37", $arrmenuakses)) {
          ?>
          <li><a href="<?php echo site_url('konseling/presensipegawai');?>"><i class="fa fa-circle-o"></i>Presensi Pegawai</a></li>
          <?php
        }
        ?>
          ...
          <li class="treeview"><a href="#"><i class="fa fa-circle-o"></i> Ekstrakurikuler</a>
            <ul class="treeview-menu">
              ...
              if (in_array("40", $arrmenuakses)) {
                ?>
                <li><a href="<?php echo base_url();?>konseling/pendaftaran"><i class="fa fa-circle-o text-red"></i>Pendaftaran</a></li>
                <?php
                }
                ?>
                ...
                if (in_array("41", $arrmenuakses)) {
                  ?>
                  <li><a href="<?php echo base_url();?>konseling/jadwal"><i class="fa fa-circle-o text-red"></i> Jadwal Ekstrakurikuler</a></li>
                  <?php
                }
                ?>
                ...
                if (in_array("42", $arrmenuakses)) {
                  ?>
                  <li><a href="<?php echo base_url();?>konseling/presensi"><i class="fa fa-circle-o text-red"></i> Presensi</a></li>
                  <?php
                }
                ?>
                ...
                if (in_array("43", $arrmenuakses)) {
                  ?>
                  <li><a href="<?php echo base_url();?>konseling/nilai"><i class="fa fa-circle-o text-red"></i> Nilai</a></li>
                  <?php
                }
                ?>
                ...
                if (in_array("44", $arrmenuakses)) {
                  ?>
                  <li><a href="<?php echo base_url();?>konseling/pembayaran"><i class="fa fa-circle-o text-red"></i> Pendanaan</a></li>
                  <?php
                }
                ?>
