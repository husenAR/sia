        ...
        <div class="col-md-12">
           <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li role="presentation" class=""><a href="#tab_content5" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false" >Berkas </a></li>
              </ul>
                  ...
                  <form class="form-horizontal form-mapel" method="post" action="<?php echo site_url('distribusi/siswa/save_siswa_mutasi_1');?>">
                ...
                <div class="form-group formgrup jarakform">            
                  ...
                  <div class="active tab-pane" id="tab_content3" aria-labelledby="profile-tab">
                    <?php echo $this->session->flashdata('pesan'); ?>
                  <form class="form-horizontal form-mapel" method="post" action="<?php echo site_url('distribusi/siswa/save_siswa_mutasi_2');?>">
                  <div class="bigbox-mapel"> 
                    <div class="box-mapel">
