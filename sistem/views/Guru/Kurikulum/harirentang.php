...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="row">
      ...
      <!-- /.col -->
      <div class="col-md-12">
       <form method="post" action="<?php echo site_url('guru/simpanharirentang'); ?>">
                ...
                <tbody>
                  ...
                  for ($i=1;$i<=8;$i++) {
                    ...
                    <tr>
                      ...
                      <td><a href="<?php echo site_url('guru/delharirentang/'.@$hari_rentang['senin'][$i]->id_rentang_jam); ?>" class="btn btn-danger" style="border-radius: 20px" size="2"><b>X</b></a></td>
                          <!-- <td>
                    ...
                    <tbody>
                      ...
                      for ($i=1;$i<=8;$i++) {
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo site_url('guru/delharirentang/'.@$hari_rentang['selasa'][$i]->id_rentang_jam); ?>" class="btn btn-danger" style="border-radius: 20px" size="2"><b>X</b></a></td>
                          <!-- <td>
                            <button type="button" class="btn btn-block btn-primary button-action btnedit" href="#editdatamapel" data-toggle="tab"> Edit </button>
                          </td> -->
                        </tr>
                    ...
                    <tbody>
                      ...
                      for ($i=1;$i<=8;$i++) {
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo site_url('/guru/delharirentang/'.@$hari_rentang['rabu'][$i]->id_rentang_jam); ?>" class="btn btn-danger" style="border-radius: 20px" size="2"><b>X</b></a></td>
                          <!-- <td>
                            <button type="button" class="btn btn-block btn-primary button-action btnedit" href="#editdatamapel" data-toggle="tab"> Edit </button>
                          </td> --> 
                        </tr>
                    ...
                    <tbody>
                      ...
                      for ($i=1;$i<=8;$i++) {
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo site_url('guru/delharirentang/'.@$hari_rentang['kamis'][$i]->id_rentang_jam); ?>" class="btn btn-danger" style="border-radius: 20px" size="2"><b>X</b></a></td>
                          <!-- <td>
                            <button type="button" class="btn btn-block btn-primary button-action btnedit" href="#editdatamapel" data-toggle="tab"> Edit </button>
                          </td> -->
                        </tr>
                    ...
                    <tbody>
                      ...
                      for ($i=1;$i<=8;$i++) {
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo site_url('guru/delharirentang/'.@$hari_rentang['jumat'][$i]->id_rentang_jam); ?>" class="btn btn-danger" style="border-radius: 20px" size="2"><b>X</b></a></td>
                          <!-- <td>
                            <button type="button" class="btn btn-block btn-primary button-action btnedit" href="#editdatamapel" data-toggle="tab"> Edit </button>
                          </td> -->
                        </tr>
                    ...
                    <tbody>
                      ...
                      for ($i=1;$i<=8;$i++) {
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo site_url('guru/delharirentang/'.@$hari_rentang['sabtu'][$i]->id_rentang_jam); ?>" class="btn btn-danger" style="border-radius: 20px" size="2"><b>X</b></a></td>
                          <!-- <td>
                            <button type="button" class="btn btn-block btn-primary button-action btnedit" href="#editdatamapel" data-toggle="tab"> Edit </button>
                          </td> -->
                        </tr>
                    ...
                    <tbody>
                      ...
                      for ($i=1;$i<=8;$i++) {
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo site_url('guru/delharirentang/'.@$hari_rentang['minggu'][$i]->id_rentang_jam); ?>" class="btn btn-danger" style="border-radius: 20px" size="2"><b>X</b></a></td>
                          <!-- <td>
                            <button type="button" class="btn btn-block btn-primary button-action btnedit" href="#editdatamapel" data-toggle="tab"> Edit </button>
                          </td> -->
                        </tr>
