            ...
            <div class="tab-pane" id="jadwalmapel">
              <div class="box">
                <div class="box-header">
                  <form>
                    <select id="jenjangjadwalmapel2" onchange="document.location = '<?php echo site_url('guru/jadwalmapel'); ?>/' + document.getElementById('jenjangjadwalmapel2').value;">
...
<!-- <a href="<?php echo site_url('guru/printjadwalmapel/'.$jenjang); ?>" ><button class="btnjdwl"><i class="fa fa-print text-red "></i> Print</button></a> -->
<a href="<?php echo site_url('guru/exportjadwalmapel/'.$jenjang); ?>" ><button class="btnjdwl"><i class="fa fa-upload text-red "></i> Export</button></a>
</div>
<!-- /.box-body -->
</div>
...
<div class="active tab-pane" id="jadwalprioritas">
  <div class="box">
    ...
    <!-- /.box-header -->
    <div class="box-body">
      <form method="post" action="<?php echo site_url('guru/simpanprioritas'); ?>">
        <table class="table table-bordered table-striped tabelmapel">
                     ...
                     for($i=0;$i<=5;$i++) {
                      ...
                      <tr>
                        ...
                        foreach (@$tabel_prioritaskhusus_senin[$i] as $rowprioritaskhusus) {
                          $z++;
                          if ($z>1) { echo ", "; }
                          echo $rowprioritaskhusus->nama.'&nbsp;<a href="'.site_url('guru/hapusprioritas/'.$rowprioritaskhusus->id_prkh).'">X</a>&nbsp;';
                        }
                        ?> </th>
                        <th><?php 
                        $z=0;
...
<div class="tab-pane" id="jadwalkhusus">
  <div class="box">
    ...
    <!-- /.box-header -->
    <div class="box-body">
     <form method="post" action="<?php echo site_url('guru/simpankhusus'); ?>">
      <table class="table table-bordered table-striped tabelmapel">
            ...
            for($i=0;$i<=12;$i++) {
              ...
              <tr>
                ...
                foreach (@$tabel_khusus_senin[$i] as $rowprioritaskhusus) {
                  $z++;
                  if ($z>1) { echo ", "; }
                  echo $rowprioritaskhusus->nama_panggilan.'&nbsp;<a href="'.site_url('guru/hapusprioritas/'.$rowprioritaskhusus->id_prkh).'">X</a>&nbsp;';
                }
                ?> </th>
                <th><?php 
                $z=0;
  ...
  <div class="tab-pane" id="kelolajadwalmapel">
    <div class="box">
      <div class="box-header">
        <form>
          <select id="jenjangjadwalmapel" onchange="document.location = '<?php echo site_url('guru/jadwalmapel'); ?>/' + document.getElementById('jenjangjadwalmapel').value;">
            <option value="7" <?php if ($jenjang == '7') { echo " selected"; } ?>> KELAS 7</option>
            <option value="8" <?php if ($jenjang == '8') { echo " selected"; } ?>> KELAS 8</option>
            <option value="9" <?php if ($jenjang == '9') { echo " selected"; } ?>> KELAS 9</option>
          </select>
      ...
      <div class="box-body">
        <div style="overflow-x: scroll; width: 1090px">
          <form method="post" action="<?php echo site_url('guru/simpanjadwalguru/senin/'.$jenjang); ?>">
        ...
        <div style="overflow-x: scroll; width: 1090px">
          <form method="post" action="<?php echo site_url('guru/simpanjadwalguru/selasa/'.$jenjang); ?>">
      ...
      <div style="overflow-x: scroll; width: 1090px">
        <form method="post" action="<?php echo site_url('guru/simpanjadwalguru/rabu/'.$jenjang); ?>">
      ...
      <div style="overflow-x: scroll; width: 1090px">
        <form method="post" action="<?php echo site_url('guru/simpanjadwalguru/kamis/'.$jenjang); ?>">
      ...
      <div style="overflow-x: scroll; width: 1090px">
        <form method="post" action="<?php echo site_url('guru/simpanjadwalguru/jumat/'.$jenjang); ?>">
      ...
      <div style="overflow-x: scroll; width: 1090px">
        <form method="post" action="<?php echo site_url('guru/simpanjadwalguru/sabtu/'.$jenjang); ?>">
      ...
      <div style="overflow-x: scroll; width: 1090px">
        <form method="post" action="<?php echo site_url('guru/simpanjadwalguru/minggu/'.$jenjang); ?>">
...
<!-- modal -->
  ...
  <script type="text/javascript">
              // function getmapel() {
              //   $.ajax({
              //     url: '<?php echo site_url('guru/getmapelkelas'); ?>/'+document.getElementById('jenjang').value,
              //     dataType: 'json',
              //     cache: false,
