  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs">
           ...
           if ($this->session->userdata('jabatan') == 'guru') {
            ?>
            <li ><a href="#datakelolamapelguru" data-toggle="tab"><?php if (@$edit_mapel) { echo "Edit"; } else { echo "Tambah"; } ?> Mata Pelajaran </a></li>
            <?php 
          } 
          ?>
                  ...
                  foreach ($tabel_namamapel as $row_namamapel) {
                    ...
                    <tr>
                      ...
                      <td> 
                       ...
                       if ($this->session->userdata('jabatan') == 'guru') {
                        ?>
                        <a class="btn btn-block btn-primary button-action btnedit" href="<?php echo site_url('guru/namamapel/'.$row_namamapel->id_namamapel); ?>" > Edit </a>
                        <a onclick="return confirm('Apakah Anda yakin?')" class="btn btn-danger btn-primary button-action btnhapus" href="<?php echo site_url('guru/hapusnamamapel/'.$row_namamapel->id_namamapel); ?>" > Hapus </a>
                        <?php 
                      }
                      ?>
        ...
        <!-- /.tab-pane -->
        <!-- Data Kelola Mapel guru -->

        <div class="tab-pane" id="datakelolamapelguru">
         <form id="formmapel" style="display:block;" class="form-horizontal formmapel" method="post" action="<?php echo site_url('guru/simpannamamapel'); ?>">
