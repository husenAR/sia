...
<!-- <link rel="stylesheet" href="<?php echo base_url(); ?>assets/guru/chosen/chosen.css"> -->
                ...
                <div class="box">
                  ...
                  <div class="box-body">
                    <div>
                      <!-- <div class="box-header jarakbox" style="padding-top: : 0px"> -->
                        <form method="post" action="<?php echo site_url('guru/simpanjammengajar'); ?>">
                  ...
                  <div class="tab-pane" id="kelolajammengajar">
                    <div class="box">
                      ...
                      <a href="<?php echo site_url('guru/printjammengajar'); ?>" class=" btn btnjdwl">Print                   <!-- /.box-body -->
