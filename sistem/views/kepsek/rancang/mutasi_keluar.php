    ...
    <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <!-- <li role="presentation" class="    "><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true" >Surat Pengajuan</a></li> -->
        ...
        <form class="form-horizontal formmapel">
              ...
              <div class="tab-pane active in" id="tab_content2" aria-labelledby="profile-tab">
              <div class="col-sm-6">
