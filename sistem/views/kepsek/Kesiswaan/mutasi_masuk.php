...
<?php
       ...
       <div class="col-sm-6">
                      ...
                      <td>
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu" role="menu">
                            <?php
                            $link_diterima = base_url()."superadmin/ubah_status_siswa_mutasi/".$row->id_pendaftar_mutasi."/Diterima";
                            $link_ditolak = base_url()."superadmin/ubah_status_siswa_mutasi/".$row->id_pendaftar_mutasi."/Ditolak";
                            $link_dicabut = base_url()."superadmin/ubah_status_siswa_mutasi/".$row->id_pendaftar_mutasi."/Dicabut";
                            ?>
             ...
             <table class="table table-striped projects">
               ...
               <div class="tab-pane">
                 <form class="form-horizontal formkaldik" method="post" enctype="multipart/form-data" action="<?php echo base_url() ?>superadmin/upload_file">
