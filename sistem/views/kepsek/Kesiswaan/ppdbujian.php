                  ...
                  <!-- end x tittle -->
                      ...
                      <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                       <!--  <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Formulir </a>
                        ...
                        <li role="presentation" class="active"><a href="#tab_content3" role="tab" id="home-tab" data-toggle="tab" aria-expanded="false">Pendaftar </a>
                        </li>
                ...
                <!-- <select class="form-control filter-tahun-ujian" name="id_tahunajaran" required>
                  <option value="semua">Tahun Ajaran</option>
                    ...
                    <?php } ?>
                     ...
                     <form method="post" action="<?php echo site_url('superadmin/ubahstatus');?>">
