  ...
  <body>
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <form id="formPartE" class="form-horizontal style-form form-goods" method="post" action="<?php echo site_url('kesiswaan/admin/pendaftar_jalur_un/updatependaftar/'.$row_pendaftar_ppdb->nisn_pendaftar); ?>" ><br>
          <?php
          ...
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Nilai UN Bahasa Indonesia </label>
             <div class="col-md-3 col-sm-3 col-xs-3">
              <input type="text" required="required" class="form-control" name="nilai_un_ind" value="<?php echo $row_pendaftar_ppdb->nilai_un_ind; ?>" id="nilai_bahasa_indo">
            </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Nilai UN Matematika </label>
             <div class="col-md-3 col-sm-3 col-xs-3">
              <input type="text" class="form-control" required="required" name="nilai_un_mat" value="<?php echo $row_pendaftar_ppdb->nilai_un_mat; ?>" id="nilai_matematika">
            </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Nilai UN IPA </label>
              <div class="col-md-3 col-sm-3 col-xs-3">
              <input type="text" required="required" class="form-control" name="nilai_un_ipa" value="<?php echo $row_pendaftar_ppdb->nilai_un_ipa; ?>" id="nilai_ipa">
            </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Nilai Prestasi </label>
             <div class="col-md-3 col-sm-3 col-xs-3">
              <input type="text" class="form-control" name="nilai_prestasi" value="<?php echo $row_pendaftar_ppdb->nilai_prestasi; ?>" id="nilai_presensi">
            </div>
          </div>
          <?php
          }
          ...
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Total Nilai </label>
             <div class="col-md-3 col-sm-3 col-xs-3">
              <input type="text" required="required" class="form-control" name="nilai_un_nun" value="<?php echo $row_pendaftar_ppdb->nilai_un_nun; ?>" id="nilai_total">
            </div>
          </div>
          <?php
          }
