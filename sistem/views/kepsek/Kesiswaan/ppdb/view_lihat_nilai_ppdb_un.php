  ...
  <body>
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <form id="formPartE" class="form-horizontal style-form form-goods" method="post" action="<?php echo site_url('kesiswaan/admin/pendaftar_jalur_un/updatenilai/'.$row_pendaftar_ppdb->nisn_pendaftar); ?>"><br>
           <div class="row">            
            <div class="col-sm-5">
