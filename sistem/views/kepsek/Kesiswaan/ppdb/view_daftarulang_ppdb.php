<div class="content-wrapper">
      ...
      <div class="col-md-12">
        <div class="nav-tabs-custom">
          <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
            <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Pengaturan Formulir </a></li>
            ...
            <li role="presentation" class=""><a href="#tab_content3" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false">Pendaftar </a></li>
            <li role="presentation" class=""><a href="#tab_content4" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false">Pengumuman</a></li>
          </ul>
          ...
          <div id="myTabContent" class="tab-content">
            <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
              <div class="form-group">
                ...
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo site_url('kesiswaan/admin/daftarulang_ppdb/saveformppdb'); ?>">  
                  <p><center>Berikan centang pada atribut formulir yang ingin dikeluarkan sebagai syarat berkas daftar ulang sebagai Peserta Didik Baru:</center></p><br> 
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-9">
                      ...
                      { 
                        if ($i<5) 
                        {
                          ?><input type="checkbox" class="flat" name="nilai<?php echo $form->id_form_daftarulang_ppdb; ?>" value="1" <?php 
                          if ($form->nilai == "1") 
                            { echo " checked"; } ?>
                          > <label><?php echo $form->atribut; ?></label><br> <?php 
                        }
                        elseif ($form!==NULL) 
                        { 
                      ...
                      <div class="modal-footer" align="left">
                        <a href="<?php echo site_url('kesiswaan/admin/daftarulang_ppdb/nonaktif'); ?>" class="btn btn-danger">Non Aktifkan Formulir</a>
  ...
  <!-- ========================================= end tab 1 ====================================== -->
            ...
            <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
              ...
              <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo site_url('kesiswaan/admin/daftarulang_ppdb/saveketentuan'); ?>" enctype="multipart/form-data">
                <div class="form-group">
            ...
            <tbody>
              ...
              foreach ($tabel_ketentuan_ppdb as $row) {
                ...
                <tr>
                  ...
                  <td>                        
                    <a data-toggle="modal" class="btn btn-info btn-xs" data-show="true" href="<?php echo site_url('kesiswaan/admin/daftarulang_ppdb/editketentuan/'.$row->id_ketentuan); ?>" data-target="#myKetentuanDU<?php echo $row->id_ketentuan; ?>">Edit</a>
                  </td>
                  <td>
   ...
   <!-- =========================================== end tab 2 ==================================== -->
          ...
          <div role="tabpanel" class="tab-pane fade" id="tab_content3" aria-labelledby="profile-tab">
            ...
            <div class="col-md-2 col-sm-6 col-xs-12 col-md-offset-5 col-sm-offset-3" align="center">
                <select class="form-control filter-tahun-duppdb" name="id_tahunajaran" required>
              ...
              <div class="col-sm-4">
                <div class="dataTables_length" id="example1_length">
                  <div class="form-group" align="right">
                    <a type="button" role="button" href=<?php echo site_url('kesiswaan/admin/daftarulang_ppdb/eksportujian');?> class="btn btn-default"><i class="fa fa-print text-red "></i> Export Data Pendaftar</a>
                  </div>
                </div>
              </div>
            </div>
            <table class="table table-striped projects examples">
              <thead>
                <tr>
                  <th style="width: 10%">No Pdftr <i class="fa fa-caret-down" aria-hidden="true"></i> </th>
                  <th style="width: 10%">Th Ajaran<i class="fa fa-caret-down" aria-hidden="true"></i> </th>
                  <th style="width: 20%">NISN <i class="fa fa-caret-down" aria-hidden="true"></i> </th>
                  <th style="width: 50%">Nama <i class="fa fa-caret-down" aria-hidden="true"></i> </th>
                  <th style="width: 10%">Verifikasi <i class="fa fa-caret-down" aria-hidden="true"></i> </th>
                  <th style="width: 10%"></th>
                </tr>
              </thead>
              <tbody class="searchable">
                ...
                $i=1;
                  ...
                  ?>
                  <tr>
                    <td><?php echo $row->nomor_pendaftar; ?></td>
                    <td><?php echo $row->tahun_ajaran; ?></td>
                    <td><?php echo $row->nisn; ?></td>
                    <td><?php echo $row->nama; ?></td>
                    <td><?php echo $row->statusver; ?></td>
                    <td>
                       <a data-toggle="modal" class="btn btn-info btn-xs" data-show="true" href="<?php echo site_url('kesiswaan/admin/daftarulang_ppdb/editberkas/'.$row->nisn); ?>" data-target="#myPendaftar<?php echo $i; ?>">Edit</a>
                    </td>
                  </tr>
...
<!-- =============================== END OF TAB CONTENT 4 ================================== -->
          ...
          <div role="tabpanel" class="tab-pane fade" id="tab_content4" aria-labelledby="profile-tab">
            ...
            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo site_url('kesiswaan/admin/daftarulang_ppdb/savepengumuman'); ?>" enctype="multipart/form-data">
              <div class="form-group">
              ...
              <tbody>
                ...
                foreach ($tabel_pengumuman_ppdb as $row) {
                  ...
                  <tr>
                    ...
                    <td>                        
                      <a data-toggle="modal" class="btn btn-info btn-xs" data-show="true" href="<?php echo site_url('kesiswaan/admin/daftarulang_ppdb/editpengumuman/'.$row->id_pengumuman_ppdb); ?>" data-target="#myPengumuman<?php echo $i; ?>">Edit</a>
                    </td>
                    <td>
