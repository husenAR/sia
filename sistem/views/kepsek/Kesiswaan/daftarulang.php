                  ...
                  <!-- end x tittle -->
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                      <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                        ...
                        <li role="presentation" class="active"><a href="#tab_content2" role="tab" id="home-tab" data-toggle="tab" aria-expanded="false">Siswa Daftar Ulang</a>
                        </li>
                      </ul>
                        ...
                        <td>
                          <?php
                            if ($row->status_siswa == 'Diterima') {
                              ...
                              echo '<span class="label label-danger">Tidak Lengkap</span>';
                            } elseif ($row->status_siswa == 'Dicabut') {
                              echo '<span class="label label-success">Lengkap</span>';
                            } else {
                              echo '<span class="label label-danger"><i>Tidak Lengkap</i></span>';
                            }
                            ?>
                        </td>
