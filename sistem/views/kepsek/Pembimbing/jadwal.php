  ...
  <!--       <center><small>Tahun Ajaran 2016-2017</small></center> -->
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url();?>kepsek">Dashboard</a></li>
      </ol>
    </section>
              ...
              <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs pull-left">
                 <!--  <li  class="active"><a href="#tab2" data-toggle="tab">Kelola Jadwal</a></li> -->
                  <li class="active"><a href="#tab1" data-toggle="tab">Jadwal Ekstrakurikuler</a></li>
                </ul>
                <div class="tab-content no-padding">
                  ...
                  <div class="chart tab-pane" id="tab2" style="position: relative; min-height: 300px;">
