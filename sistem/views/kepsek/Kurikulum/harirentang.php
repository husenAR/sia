              ...
              <table class="table table-striped projects">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo site_url('superadmin/kurikulum/delharirentang/'.@$hari_rentang['senin'][$i]->id_rentang_jam); ?>" class="btn btn-danger" style="border-radius: 20px" size="2"><b>X</b></a></td>
                          <!-- <td>
              ...
              <table class="table table-striped projects">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo site_url('superadmin/kurikulum/delharirentang/'.@$hari_rentang['selasa'][$i]->id_rentang_jam); ?>" class="btn btn-danger" style="border-radius: 20px" size="2"><b>X</b></a></td>
                          <!-- <td>
                            <button type="button" class="btn btn-block btn-primary button-action btnedit" href="#editdatamapel" data-toggle="tab"> Edit </button>
                          </td> -->
                        </tr>
              ...
              <table class="table table-striped projects">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo site_url('superadmin/kurikulum/delharirentang/'.@$hari_rentang['kamis'][$i]->id_rentang_jam); ?>" class="btn btn-danger" style="border-radius: 20px" size="2"><b>X</b></a></td>
                          <!-- <td>
                            <button type="button" class="btn btn-block btn-primary button-action btnedit" href="#editdatamapel" data-toggle="tab"> Edit </button>
                          </td> -->
                        </tr>
              ...
              <table class="table table-striped projects">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo site_url('superadmin/kurikulum/delharirentang/'.@$hari_rentang['jumat'][$i]->id_rentang_jam); ?>" class="btn btn-danger" style="border-radius: 20px" size="2"><b>X</b></a></td>
                          <!-- <td>
                            <button type="button" class="btn btn-block btn-primary button-action btnedit" href="#editdatamapel" data-toggle="tab"> Edit </button>
                          </td> -->
                        </tr>
              ...
              <table class="table table-striped projects">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo site_url('superadmin/kurikulum/delharirentang/'.@$hari_rentang['sabtu'][$i]->id_rentang_jam); ?>" class="btn btn-danger" style="border-radius: 20px" size="2"><b>X</b></a></td>
                          <!-- <td>
                            <button type="button" class="btn btn-block btn-primary button-action btnedit" href="#editdatamapel" data-toggle="tab"> Edit </button>
                          </td> -->
                        </tr>
              ...
              <table class="table table-striped projects">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo site_url('superadmin/kurikulum/delharirentang/'.@$hari_rentang['minggu'][$i]->id_rentang_jam); ?>" class="btn btn-danger" style="border-radius: 20px" size="2"><b>X</b></a></td>
                          <!-- <td>
                            <button type="button" class="btn btn-block btn-primary button-action btnedit" href="#editdatamapel" data-toggle="tab"> Edit </button>
                          </td> -->
                        </tr>
