...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/superadmin/sweetalert/sweetalert.css'); ?>">
    <link rel="stylesheet" href="<?php echo base_url();?>/assets/superadmin/chosen/chosen.min.css">
  <!--   link data table -->
 ...
 <script src="<?php echo base_url(); ?>assets/superadmin/chosen/chosen.jquery.js" type="text/javascript"></script>
...
<body class=" skin-blue sidebar-mini" >
  <div class="wrapper">
    ...
    <header class="main-header">
      <a href="<?php echo site_url('sistem/superadmin');?>" class="logo">
      ...
      <nav class="navbar navbar-static-top">
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            <li>
              <a href="<?php echo site_url('sistem/superadmin/profile');?>" ><i class="fa fa-people "></i>Profile</a>
            </li>
            <li>
                
              <a onclick="return confirm('Apakah Anda Ingin Keluar Dari Sistem?');" href="<?php echo site_url('sistem/logout');?>" ><i class="fa fa-sign-out"></i>Log Out</a>
            </li>
          </ul>
        </div>
      </nav>
        ...
        <ul class="sidebar-menu">
          ...
          if (in_array("1", $arrmenuakses)) {
                  ...
                  <li ><a href="#"><i class="fa fa-circle-o"></i> Penerimaan Peserta Didik Baru </a>
                   <ul class="treeview-menu">
                    ...
                    if (in_array("3", $arrmenuakses)) {
                      ?>
                      <li ><a href="<?php echo base_url();?>sistem/superadmin/ppdbujian"><i class="fa fa-circle-o text-red"></i> PPDB Ujian</a></li>
                      <?php
                    }
                    ?>
                    ...
                    if (in_array("4", $arrmenuakses)) {
                      ?>
                      <li ><a href="<?php echo base_url();?>sistem/superadmin/ppdbneg"><i class="fa fa-circle-o text-red"></i> PPDB UN</a></li>
                      <?php
                    }
                    ?>
                ...
                <li ><a href="#"><i class="fa fa-circle-o"></i> Daftar Ulang </a> 
                 <ul class="treeview-menu">
                   ...
                   if (in_array("6", $arrmenuakses)) {
                    ?>
                    <li ><a href="<?php echo base_url();?>sistem/superadmin/daftarulang"><i class="fa fa-circle-o text-red"></i>Peserta Didik Baru</a></li>
                    <?php
                  }
                  ?>
                  <!-- ============================== -->
                  ...
                  if (in_array("7", $arrmenuakses)) {
                    ?>
                    <li ><a href="<?php echo base_url();?>sistem/superadmin/daftarkenaikan"><i class="fa fa-circle-o text-red"></i>Kenaikan Kelas</a></li>
                    <?php
                  }
                  ?>
                  <!-- ============================== -->
              ...
              <li><a href="distribusi.php"><i class="fa fa-circle-o"></i> Distribusi Kelas </a>
                <ul class="treeview-menu">
                  ...
                  if (in_array("9", $arrmenuakses)) {
                    ?>                  
                    <li ><a href="<?php echo base_url();?>sistem/superadmin/distribusi_reg"><i class="fa fa-circle-o text-red"></i> Kelas Reguler </a></li>
                    <?php
                  }
                  ?>
                  ...
                  if (in_array("10", $arrmenuakses)) {
                    ?>
                    <li ><a href="<?php echo base_url();?>sistem/superadmin/distribusi_tam"><i class="fa fa-circle-o text-red"></i> Kelas Tambahan </a></li>
                    <?php
                  }
                  ?>  
                  ...
                  if (in_array("11", $arrmenuakses)) {
                    ?>
                    <li ><a href="<?php echo base_url();?>sistem/superadmin/klinik_un"><i class="fa fa-circle-o text-red"></i> Klinik UN</a></li>
                    <?php
                  }
                  ?>
                </ul>
              ...
              <li><a href="mutasi.php"><i class="fa fa-circle-o"></i> Mutasi </a>
                <ul class="treeview-menu">
                  ...
                  if (in_array("13", $arrmenuakses)) {
                    ?>
                    <li ><a href="<?php echo base_url();?>sistem/superadmin/mutasi_masuk"><i class="fa fa-circle-o text-red"></i> Mutasi Masuk</a></li>
                    <?php
                  }
                  ?>
                  ...
                  if (in_array("14", $arrmenuakses)) {
                    ?>
                    <li ><a href="<?php echo base_url();?>sistem/superadmin/mutasi_keluar"><i class="fa fa-circle-o text-red"></i> Mutasi Keluar</a></li>
                    <?php
                  }
                  ?>
                </ul>
            ...
            if (in_array("15", $arrmenuakses)) {
              ?>
              <li><a href="<?php echo base_url();?>sistem/superadmin/bukuinduk"><i class="fa fa-circle-o"></i>Buku Induk</a></li>
              <?php
            }
            ?>
          </ul>
              ...
              <li ><a href="harirentang.php"><i class="fa fa-circle-o"></i> Penjadwalan</a>
                <ul class="treeview-menu">
                 ...
                 if (in_array("18", $arrmenuakses)) {
                  ?>
                  <li ><a href="<?php echo site_url('sistem/superadmin/namamapel'); ?>"><i class="fa fa-circle-o text-red"></i> Tambah Mapel</a></li>
                  <?php
                }
                ?>
                ...
                if (in_array("19", $arrmenuakses)) {
                  ?>
                  <li ><a href="<?php echo site_url('sistem/superadmin/mapel'); ?>"><i class="fa fa-circle-o text-red"></i> Mengelola Mapel</a></li>
                  <?php
                }
                ?>
                ...
                if (in_array("20", $arrmenuakses)) {
                  ?>
                  <li ><a href="<?php echo site_url('sistem/superadmin/harirentang'); ?>"><i class="fa fa-circle-o text-red"></i> Mengelola Hari & Jam</a></li>
                  <?php
                }
                ?>
                ...
                if (in_array("21", $arrmenuakses)) {
                  ?>
                  <li ><a href="<?php echo site_url('sistem/superadmin/jammengajar'); ?>"><i class="fa fa-circle-o text-red"></i> Jam Mengajar Guru</a></li>
                  <?php
                }
                ?>
                ...
                if (in_array("22", $arrmenuakses)) {
                  ?>
                  <li ><a href="<?php echo site_url('sistem/superadmin/jadwalmapel'); ?>"><i class="fa fa-circle-o text-red"></i> Jadwal Mapel</a></li>
                  <?php
                }
                ?>
                ...
                if (in_array("23", $arrmenuakses)) {
                  ?>
                  <li ><a href="<?php echo site_url('sistem/superadmin/jadwalpiketguru'); ?>"><i class="fa fa-circle-o text-red"></i> Jadwal Piket Guru</a></li>
                  <?php
                }
                ?>
                ...
                if (in_array("24", $arrmenuakses)) {
                  ?>
                  <li ><a href="<?php echo site_url('sistem/superadmin/jadwaltambahan'); ?>"><i class="fa fa-circle-o text-red"></i> Jadwal Tambahan</a></li>
                  <?php
                }
                ?>
                ...
                if (in_array("25", $arrmenuakses)) {
                  ?>
                  <li ><a href="<?php echo site_url('sistem/superadmin/Ekstrakurikuler'); ?>"><i class="fa fa-circle-o text-red"></i> Mengelola Ekstrakurikuler</a></li>
                  <?php
                }
                ?>
              </ul>
            ...
            <li ><a href="#"><i class="fa fa-circle-o"></i> Penilaian</a>
             <ul class="treeview-menu">
               ...
               if (in_array("27", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>sistem/superadmin/kaldik"><i class="fa fa-circle-o text-red"></i> Kaldik</a></li>
                <?php
              }
              ?>
              <?php 
              if (in_array("28", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>sistem/superadmin/kurikulum"><i class="fa fa-circle-o text-red"></i> Kurikulum Sekolah</a></li>
                <?php
              }
              ?>
              <?php 
              if (in_array("29", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>sistem/superadmin/presensi_siswa"><i class="fa fa-circle-o text-red"></i> Presensi Siswa</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("30", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>sistem/superadmin/nilaisiswa"><i class="fa fa-circle-o text-red"></i> Nilai Siswa</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("31", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>sistem/superadmin/kategorinilai"><i class="fa fa-circle-o text-red"></i> Kategori Nilai</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("32", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>sistem/superadmin/jenisnilaiakhir"><i class="fa fa-circle-o text-red"></i> Jenis Nilai Akhir</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("33", $arrmenuakses)) {
                ?>
                <li><a href="<?php echo base_url();?>sistem/superadmin/deskripsinilai"><i class="fa fa-circle-o text-red"></i> Deskripsi Nilai</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("34", $arrmenuakses)) {
                ?>
                <li><a href="<?php echo base_url();?>sistem/superadmin/rapor"><i class="fa fa-circle-o text-red"></i> Rapor</a></li>
                <?php
              }
              ?>
            </ul>
  ...
  if (in_array("35", $arrmenuakses)) {
    ...
    <li class="treeview">
      ...
      if (in_array("36", $arrmenuakses)) {
        ?>
        <ul class="treeview-menu">
          <li><a href="<?php echo site_url('sistem/superadmin/pegawaibaru');?>"><i class="fa fa-circle-o"></i>Data Pegawai</a></li>
          <?php
        }
        ?>
        ...
        if (in_array("37", $arrmenuakses)) {
          ?>
          <li><a href="<?php echo site_url('sistem/superadmin/presensipegawai');?>"><i class="fa fa-circle-o"></i>Presensi Pegawai</a></li>
          <?php
        }
        ?>
          ...
          <li class="treeview"><a href="#"><i class="fa fa-circle-o"></i> Ekstrakurikuler</a>
            <ul class="treeview-menu">
              ...
              if (in_array("40", $arrmenuakses)) {
                ?>
                <li><a href="<?php echo base_url();?>sistem/superadmin/pendaftaran"><i class="fa fa-circle-o text-red"></i>Pendaftaran</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("41", $arrmenuakses)) {
                ?>
                <li><a href="<?php echo base_url();?>sistem/superadmin/jadwal"><i class="fa fa-circle-o text-red"></i> Jadwal Ekstrakurikuler</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("42", $arrmenuakses)) {
                ?>
                <li><a href="<?php echo base_url();?>sistem/superadmin/presensi"><i class="fa fa-circle-o text-red"></i> Presensi</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("43", $arrmenuakses)) {
                ?>
                <li><a href="<?php echo base_url();?>sistem/superadmin/nilai"><i class="fa fa-circle-o text-red"></i> Nilai</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("44", $arrmenuakses)) {
                ?>
                <li><a href="<?php echo base_url();?>sistem/superadmin/pembayaran"><i class="fa fa-circle-o text-red"></i> Pendanaan</a></li>
                <?php
              }
              ?>
          ...
          <li class="treeview"><a href="#"><i class="fa fa-circle-o"></i> Bimbingan Konseling</a>
           <ul class="treeview-menu">
            ...
            if (in_array("46", $arrmenuakses)) {
              ?>
              <li ><a href="<?php echo base_url();?>sistem/superadmin/keterlambatan"><i class="fa fa-circle-o text-red"></i> Keterlambatan & Jam</a></li>
              <?php 
            }
            ?>
            ...
            if (in_array("47", $arrmenuakses)) {
              ?>
              <li><a href="<?php echo base_url();?>sistem/superadmin/absensi_harian"><i class="fa fa-circle-o text-red"></i> Perizinan</a></li>
              <?php 
            }
            ?>
            ...
            if (in_array("48", $arrmenuakses)) {
              ?>
              <li><a href="<?php echo base_url();?>sistem/superadmin/pelanggaran"><i class="fa fa-circle-o text-red"></i> Pelanggaran</a></li>
              <?php 
            }
            ?>
            ...
            if (in_array("49", $arrmenuakses)) {
              ?>
              <li><a href="<?php echo base_url();?>sistem/superadmin/prestasi"><i class="fa fa-circle-o text-red"></i> Prestasi</a></li>
              <?php 
            }
            ?>
          </ul>
...
<li class="treeview">
  <a href="<?php echo site_url('sistem/superadmin/rekapkehadiran');?>">
    <i class="fa fa-circle-o text-aqua"></i> <span>Rekap Kehadiran Pribadi</span>
  </a>
</li>

<li class="treeview">
  <a href="<?php echo site_url('sistem/superadmin/jabatan');?>">
    <i class="fa fa-circle-o text-aqua"></i> <span>Manajemen Role</span>
  </a>
</li>

<li class="treeview">
  <a href="<?php echo site_url('sistem/superadmin/tahunajaran');?>">
    <i class="fa fa-circle-o text-aqua"></i> <span>Tahun Ajaran</span>
  </a>
</li>

<li class="treeview">
  <a href="<?php echo site_url('sistem/superadmin/gantipasswordsiswa');?>">
...
<li class="treeview">
  ...
  <ul class="treeview-menu">
    <li><a href="<?php echo site_url('sistem/superadmin/gantipassword');?>">Ganti Password</a></li> 
  </ul> 
  <ul class="treeview-menu">
    <li><a href="<?php echo site_url('sistem/superadmin/harilibur');?>">Setting Hari Libur</a></li> 
  </ul> 
</li>
