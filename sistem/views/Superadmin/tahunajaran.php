      ...
      <div class="col-md-12">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php if ($key->id_setting == "") { ?>
                    <a type="button" class="btn btn-success btn-xs" href="<?php echo site_url('sistem/superadmin/aktifkantahunajaran/'.$key->id_tahun_ajaran); ?>">Aktif</a><?php }?>
        ...
        <!-- /.tab-pane -->
          ...
          <div class="tab-pane" id="tambahtahunajaran">
                <form class="form-horizontal formmapel" method="post" action="<?php echo site_url('sistem/superadmin/tambahtahunajaran'); ?>">
                  ...
                  <div class="box-mapel" style="padding: 2% 0">
                      ...
                      <button type="submit" role="button" name="submit" class="btn btn-danger">Tambah Tahun AJaran</button>
                         <a href="<?php echo site_url('sistem/superadmin/tahunajaran');?>" type="button" role="button" class="btn btn-danger">Cancel</a>
