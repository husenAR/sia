      ...
      <div class="col-md-12">
            ...
            <table id="example1" class="table table-bordered table-striped" > 
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a type="button" class="btn btn-danger btn-xs" href="<?php echo site_url('sistem/superadmin/deleteharilibur/'.$key->id_tanggal_libur); ?>">Hapus</a>
            ...
            <table id="example3" class="table table-bordered table-striped" > 
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a type="button" class="btn btn-danger btn-xs" href="<?php echo site_url('sistem/superadmin/deletehariliburnasional/'.$key->id_tanggal_libur_nasional); ?>">Hapus</a>
                    <!-- <button type="button" class="btn btn-error btn-xs" style="background-color: red">Non-Aktif</button> -->
                  </td>
                </tr>
                <?php $no++; }?>
        ...
        <!-- /.tab-pane -->
          ...
          <div class="tab-pane" id="tambahharilibur">
                <form class="form-horizontal formmapel" method="post" action="<?php echo site_url('sistem/superadmin/simpanharilibur'); ?>">
                  ...
                  <div class="box-mapel" style="padding: 2% 0">
                      ...
                      <button type="submit" role="button" name="submit" class="btn btn-danger">Tambah</button>
                         <a href="<?php echo site_url('sistem/superadmin/harilibur');?>" type="button" role="button" class="btn btn-danger">Cancel</a>
            ...
            <div class="tab-pane" id="tambahhariliburnasional">
                <form class="form-horizontal formmapel" method="post" action="<?php echo site_url('sistem/superadmin/simpanhariliburnasional'); ?>">
                  <div class="bigbox-mapel"> 
                  <div class="box-header">
                  <br>
