<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url();?>superadmin/index">Dashboard</a></li>
      </ol>
    </section>
        ...
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            <div class="active tab-pane" id="kelolamapel">
             ...
             <form class="form-horizontal formmapel" method="post" action="<?php echo base_url();?>superadmin/hasil_pembagian_agama">
          ...
          <div class="form-group formgrup jarakform">
            ...
            <div class="col-md-2 col-sm-12 col-xs-12 form-group">
              <ul class="to_do">
                <li>
                 <p><input type="checkbox" name="pilihlainnya<?php echo $i; ?>" value="true"s>Lainnya</p>
               </li>
             </ul>
           </div>
           <div class="col-md-2 col-sm-12 col-xs-12 form-group">
