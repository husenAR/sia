                ...
                <!--    <div class="form-group formgrup jarakform" >
                 ...
                 <div class="form-group formgrup jarakform" >
                  ...
                  <div class="col-sm-4">
                   ...
                   <input type="checkbox" name="menuakses[]" value="31" <?php if (in_array("31", $arrmenuakses)) { echo " checked"; } ?>>31. Kategori Nilai<br/>
                   <input type="checkbox" name="menuakses[]" value="32" <?php if (in_array("32", $arrmenuakses)) { echo " checked"; } ?>>32. Jenis Nilai Akhir<br/>
                   <input type="checkbox" name="menuakses[]" value="33" <?php if (in_array("33", $arrmenuakses)) { echo " checked"; } ?>>33. Deskripsi Nilai<br/>
                   <input type="checkbox" name="menuakses[]" value="34" <?php if (in_array("34", $arrmenuakses)) { echo " checked"; } ?>>34. Rapor<br/><br>


                   <input type="checkbox" name="menuakses[]" value="35" <?php if (in_array("35", $arrmenuakses)) { echo " checked"; } ?>>35. Kepegawaian<br/>
                   <input type="checkbox" name="menuakses[]" value="36" <?php if (in_array("36", $arrmenuakses)) { echo " checked"; } ?>>36. Data Pegawai<br/>
                   <input type="checkbox" name="menuakses[]" value="37" <?php if (in_array("37", $arrmenuakses)) { echo " checked"; } ?>>37. Presensi Pegawai<br/><br>

                   <input type="checkbox" name="menuakses[]" value="38" <?php if (in_array("38", $arrmenuakses)) { echo " checked"; } ?>>38. Non Akademik<br/>
                   <input type="checkbox" name="menuakses[]" value="39" <?php if (in_array("39", $arrmenuakses)) { echo " checked"; } ?>>39. Ekstrakurikuler<br/>
                   <input type="checkbox" name="menuakses[]" value="40" <?php if (in_array("40", $arrmenuakses)) { echo " checked"; } ?>>40. Pendaftaran<br/>
                   <input type="checkbox" name="menuakses[]" value="41" <?php if (in_array("38", $arrmenuakses)) { echo " checked"; } ?>>41. Jadwal Ekstrakurikuler<br/>
                   <input type="checkbox" name="menuakses[]" value="42" <?php if (in_array("39", $arrmenuakses)) { echo " checked"; } ?>>42. Presensi<br/>
                   <input type="checkbox" name="menuakses[]" value="43" <?php if (in_array("40", $arrmenuakses)) { echo " checked"; } ?>>43. Nilai<br/>
                   <input type="checkbox" name="menuakses[]" value="44" <?php if (in_array("44", $arrmenuakses)) { echo " checked"; } ?>>44. Pendanaan<br/><br>

                   <input type="checkbox" name="menuakses[]" value="45" <?php if (in_array("45", $arrmenuakses)) { echo " checked"; } ?>>45. Bimbingan Konseling<br/>
                   <input type="checkbox" name="menuakses[]" value="46" <?php if (in_array("46", $arrmenuakses)) { echo " checked"; } ?>>46. Keterlambatan & Jam<br/>
                   <input type="checkbox" name="menuakses[]" value="47" <?php if (in_array("47", $arrmenuakses)) { echo " checked"; } ?>>47. Perizinan<br/>
                   <input type="checkbox" name="menuakses[]" value="48" <?php if (in_array("48", $arrmenuakses)) { echo " checked"; } ?>>48. Pelanggaran<br/>
                   <input type="checkbox" name="menuakses[]" value="49" <?php if (in_array("49", $arrmenuakses)) { echo " checked"; } ?>>49. Prestasi<br/>
