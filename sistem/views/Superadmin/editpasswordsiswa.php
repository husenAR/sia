...
?>
              ...
              <div class="tab-pane" id="updatepasswordsiswa">
                <form class="form-horizontal formmapel" method="post" action="<?php echo site_url('sistem/superadmin/updatepasswordsiswa'); ?>">
                  <div class="bigbox-mapel"> 
                    ...
                    <div class="form-group">
                      <div class="col-sm-offset-2 col-sm-5">
                       ...
                       <a href="<?php echo base_url();?>/sistem/superadmin/gantipasswordsiswa" type="button" role="button" class="btn btn-danger">Cancel</a>
                     </div>
                   </div>
                 </div>
                 </form>
