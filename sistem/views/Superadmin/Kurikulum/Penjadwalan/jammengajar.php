...
<!-- <link rel="stylesheet" href="<?php echo base_url(); ?>assets/superadmin/chosen/chosen.css"> -->
          ...
          <div class="nav-tabs-custom">
              ...
              <div class="active tab-pane" id="jammengajar">
                <div class="box">
                  ...
                  <div class="tab-pane" id="kelolajammengajar">
                    <div class="box">
                            ...
                            <tbody>
                              ...
                              foreach ($tabel_jammengajar as $row_jammengajar) {
                                ...
                                <tr>
                                  ...
                                  <td><a onclick="return confirm('Apakah Anda yakin?')" href="<?php echo site_url('superadmin/hapusjammengajar/'.$row_jammengajar->id_jam_mgjr); ?>" class="btn btn-danger">Hapus</a></td>
                      ...
                      <a href="<?php echo site_url('superadmin/printjammengajar'); ?>" class=" btn btnjdwl">Print                   <!-- /.box-body -->
                ...
                <script type="text/javascript">
                  function getinfoguru(nomor) {
                    $.ajax({
                      url: '<?php echo site_url('superadmin/getinfoguru'); ?>/'+document.getElementById('NIP'+nomor).value,
                      dataType: 'json',
                      cache: false,
            ...
            if ($this->session->userdata('jabatan') == 'Guru') {
             ...
             <script type="text/javascript">
                  function getinfoguru(nomor) {
                    $.ajax({
                      url: '<?php echo site_url('guru/getinfoguru'); ?>/'+document.getElementById('NIP'+nomor).value,
                      dataType: 'json',
                      cache: false,
                      success: function(msg){
                //alert('ok');
