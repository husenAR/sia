  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs">
           ...
           if ($this->session->userdata('jabatan') == 'Superadmin') {
            ?>
            <li ><a href="#datakelolamapelsuperadmin" data-toggle="tab"><?php if (@$edit_mapel) { echo "Edit"; } else { echo "Tambah"; } ?> Mata Pelajaran </a></li>
            <?php 
          } 
          ?>
        ...
        <div class="tab-pane" id="datakelolamapelsuperadmin">
