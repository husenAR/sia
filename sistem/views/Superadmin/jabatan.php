            ...
            <table id="example2" class="table table-bordered table-striped"> 
              ...
              <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo $key->Nama;?></td>
                    <td>-<?php //echo $key->nama_jabatan;?></td>     
                    <td> <a href="<?php echo base_url();?>index.php/sistem/superadmin/editjabatan/<?php echo $key->NIP;?>" type="button" role="button" class="btn btn-block btn-primary button-action btnedit">Tambah</a>
              ...
              <a href="<?php echo base_url();?>index.php/sistem/superadmin/setjabatan" class="btn btn-primary" >Tambah</a>
            </div>
          </div>
            ...
            <table id="example3" class="table table-bordered table-striped">
              ...
              <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo $key->Nama;?></td>
                    <td><?php echo $key->nama_jabatan;?></td>     
                    <td> <a href="<?php echo base_url();?>index.php/sistem/superadmin/editjabatan/<?php echo $key->NIP;?>" type="button" role="button" class="btn btn-block btn-primary button-action btnedit">Edit</a>
            ...
            <table  class="table table-bordered table-striped"> 
              ...
              <tbody>
                  ...
                  <tr>
                    ...
                    <td> <a href="<?php echo base_url();?>index.php/sistem/superadmin/editjenisjabatan/<?php echo $key->id_jabatan;?>" type="button" role="button" class="btn btn-block btn-primary button-action btnedit">Edit</a>
                      <!-- <button type="button" class="btn btn-block btn-primary button-action btnhapus">Hapus</button> -->
                    </td>   
