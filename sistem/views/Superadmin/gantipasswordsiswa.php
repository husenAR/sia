               ...
               <div class="box">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td> <a href="<?php echo base_url();?>sistem/superadmin/editpasswordsiswa/<?php echo $key->nisn;?>" type="button" role="button" class="btn btn-block btn-primary button-action btnedit">Edit</a></td>
                  </tr>
                  <?php $no++; }?>
                </tbody>
                </table> 
