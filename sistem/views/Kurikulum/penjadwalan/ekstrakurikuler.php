      ...
      <div class="col-md-12">
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs">
           <li class="active"><a href="#dataekskul" data-toggle="tab"><?php if (@$edit_jadwalekskul) { echo "Edit"; } else { echo "Tambah"; } ?> Jadwal Ekstrakurikuler</a></li>
           <li><a href="#dataekstrakurikuler" data-toggle="tab">Data Ekstrakurikuler </a></li>
         </ul>
                ...
                <tbody>
                  ...
                  foreach ($tabel_jadwalekskul as $row_jadwalekskul) {
                    ...
                    <tr>
                      ...
                      <td><?php echo $row_jadwalekskul->jam_mulai; ?></td>
                      <td><?php echo $row_jadwalekskul->jam_selesai; ?></td>
                      ...
                      <td> 
                        ...
                        <a class="btn btn-danger btn-primary button-action btnhapus" href="<?php echo site_url('penjadwalan/kurikulum/hapusjadwalekskul/'.$row_jadwalekskul->id_jadwal_ekskul); ?>" > Hapus </a>
                      </td>               
                    </tr>
                    <?php
                  }
