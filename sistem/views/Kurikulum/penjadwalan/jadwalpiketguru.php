                ...
                <div class="box">
                  ...
                  <div class="box-body">
                    ...
                    <table class="table table-bordered table-striped tabelmapel">
                      <thead>
                        <select class="kodepiket" name="id_tahun_ajaran">
                            <option value="">Pilih tahun ajaran</option>
                              <?php
                            foreach ($tabel_tahunajaran as $row_tahunajaran) {
                            ?>
                            <option value="<?php echo $row_tahunajaran->id_tahun_ajaran; ?>"><?php echo $row_tahunajaran->semester; ?>. <?php echo $row_tahunajaran->tahun_ajaran; ?></option>
                            <?php
                            }
                            ?>
                            </select>
