...
<body>
  <div class="modal-dialog" >
     ...
     <div class="modal-content"> 
      <form class="form-horizontal formgrup"  action="<?php echo site_url("nilai/akademik/ubah_kaldik/".$a->id_kaldik); ?>" method="post" enctype="multipart/form-data">
        <div class="bigbox-mapel" > 
          <div class="box-mapel">
            ...
            <div class="form-group formgrup jarakform">
              ...
              <div class="col-sm-4"><img src="<?php echo base_url(); ?>assets/simbol/<?php echo $a->simbol_kaldik; ?>" width="50"/><br/>
