        ...
        <div class="wrapper">
          ...
          <aside class="main-sidebar">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="<?php echo base_url('akademik/KALDIK') ?>"><i class="fa fa-circle-o text-red "></i> <span>Kaldik</span></a></li>
                  ...
                  <div class="bigbox-mapel"> 
                    <div class="box-mapel">
                      ...
                      <div class="form-group formgrup jarakform">
                        ...
                        <div class="col-sm-4">
                          <input type="file" required="required" class="form-control"  name="simbol_kaldik" placeholder="Simbol">
                        </div>
                      </div>
