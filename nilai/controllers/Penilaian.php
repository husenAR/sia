...
public function nilaisiswa(){
    ...
    //             $np = $np + @$this->M_data->getNilaiSiswa(array('nilai_siswa.nisn'=>$rowsiswa->nisn, 'nilai_siswa.mapel_id'=>$rowmapel->id_mapel, 'nilai_siswa.jenis_na_id'=>'3', 'id_kategorinilai' => $rowkategorinilai->id_kategorinilai))->nilai;
...
// );
  ...
  $this->load->model('M_data');
    ...
    $this->load->view('penilaian/view_template_nilai',$data);
...
//   header("Content-Disposition: attachment; filename=\"".basename('Nilai-'.$nama_kelas.'-'.$bln.'.xlsx')."\"");
...
public function Kompetensi(){
    ...
    $this->load->view('penilaian/Kompetensi',$data);
...
public function ubah_kompetensi(){
    ...
    $this->M_data->editKompetensi($data,$this->uri->segment(3));
...
public function form_edit_kompetensi(){
    $this->load->model('M_data');
    $data['a']=$this->M_data->selectKompetensi($this->uri->segment(3));
    $this->load->view('penilaian/edit/edit_kompetensi',$data);
}
