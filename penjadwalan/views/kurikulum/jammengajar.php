                  ...
                  <div class="box-body">
                    <div>
                      <!-- <div class="box-header jarakbox" style="padding-top: : 0px"> -->
                        <form method="post" action="<?php echo site_url('penjadwalan/kurikulum/simpanjammengajar'); ?>">
                            ...
                            <tbody>
                              ...
                              foreach ($tabel_jammengajar as $row_jammengajar) {
                                ...
                                <tr>
                                  ...
                                  <td><a onclick="return confirm('Apakah Anda yakin?')" href="<?php echo site_url('penjadwalan/kurikulum/hapusjammengajar/'.$row_jammengajar->id_jam_mgjr); ?>" class="btn btn-danger">Hapus</a></td>
