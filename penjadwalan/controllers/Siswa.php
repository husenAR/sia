...
function __construct(){
	...
	public function index(){
		...
		$this->template->load('penjadwalan/siswa/dashboard_siswa','penjadwalan/siswa/home', $data);
	}
...
$data['nama'] = $this->session->Nama;
		...
		$this->template->load('penjadwalan/siswa/dashboard_siswa','penjadwalan/siswa/klinik_un_siswa',$data);
	}
	...
	public function siswa_mutasi(){
		...
		$this->template->load('penjadwalan/siswa/dashboard_siswa','penjadwalan/siswa/siswa_mutasi',$data);
	}
	...
	public function jadwalmapel_siswa(){
		...
		$this->template->load('penjadwalan/siswa/dashboard_siswa','penjadwalan/siswa/jadwalmapel_siswa',$data);
	}
	...
	public function jadwaltambahan_siswa(){
		...
		//if (@$this->uri->segment(4) == '') { $jenjang = 7; } else { $jenjang = @$this->uri->segment(4); }
		$kelas_tambahan = $row_siswatam->kelas_tambahan;
		$data['kelas_tambahan'] = $kelas_tambahan;
		...
		$data['tabel_jadwaltambahan'] = $this->mod_jadwaltambahan->get(array('kelas_tambahan.kelas_tambahan' => $kelas_tambahan));

	
		
		
		$this->template->load('penjadwalan/siswa/dashboard_siswa','penjadwalan/siswa/jadwaltambahan_siswa',$data);
	}
