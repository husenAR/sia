...
class Sekolah extends CI_Controller {
  ...
  //        $data['settingform'] = $settingform;
		$this->template->load('sekolah/dashboard_sekolah','sekolah/home');
	}

	public function mutasi(){

		$this->template->load('sekolah/dashboard_sekolah','sekolah/mutasi');
	}

	public function form_mutasimasuk(){

		$this->load->model('Mod_form_mutasi_masuk');
		...
		$this->template->load('sekolah/dashboard_sekolah','sekolah/form_mutasimasuk', $data);
	...
	public function savependaftar_mutasi() {
		...
		$this->load->model('Mod_siswa_mutasi_masuk');
		$arrdata = array(
		...
		redirect('sekolah/form_mutasimasuk');
	...
	public function pengumuman(){
		...
		$this->template->load('sekolah/dashboard_sekolah','sekolah/pengumuman');
	}
