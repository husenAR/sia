...
class Guru extends CI_Controller {
	...
	public function index()
	{
		...
		$this->template->load('guru/dashboard_guru','guru/home', $data);
	}
	...
	public function jadwalmapel_guru()
	{
		...
		$this->template->load('guru/dashboard_guru','guru/jadwalmapel_guru' ,$data);
	}
	...
	public function jadwalpiketguru_guru()
	{
		...
		$this->template->load('guru/dashboard_guru','guru/jadwalpiketguru_guru' ,$data);
	}
	...
	public function jadwaltambahan_guru()
	{
		...
		$this->template->load('guru/dashboard_guru','guru/jadwaltambahan_guru' ,$data);
	}
